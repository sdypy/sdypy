...
**Scope:** Umbrella-local — the SEP documents under `docs/seps/` live only in the core repository; the sibling packages hold no SEPs. Governed by SEP 0.
