...
**Scope:** Org-wide — binds all six first-level sibling packages, **except** the *Umbrella `__all__` matches the six first-level names* requirement, which is umbrella-local. Governed by SEP 2.
